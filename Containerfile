...
RUN \
    ...
    mv target/x86_64-unknown-linux-musl/release/pitsa.xz app.xz && \
    mkdir -p /work/data && \
...
COPY --from=runner  --chown=10001:0 /the-ground-up /pitsa
...
#ENV PITSA_SIGN_PROVIDER
#ENV PITSA_SIGN_TRUST
#ENV PITSA_SIGN_TEMPLATE
#ENV PITSA_SIGN_CREDENTIALS
#ENV PITSA_SIGN_IDENTITY
